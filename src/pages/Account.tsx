          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
            ...
            <Card className="shadow-card">
              <CardContent className="pt-6 text-center">
                ...
                <p className="text-sm text-muted-foreground mb-4">{profileData.role}</p>
            ...
            <Card className="lg:col-span-2 shadow-card">
              ...
              <CardContent>
                <form onSubmit={handleSave} className="space-y-6">
                  ...
                  <Button type="submit" className="bg-gradient-primary shadow-glow hover:opacity-90 transition-opacity">
                    Save Changes
                  </Button>
                </form>
              </CardContent>
